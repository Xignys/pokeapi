...
const mostrarCarta = (pokemon) => {//poquemon es la data de la funcion anterior
    console.log(pokemon)
    const template = document.querySelector('poke-img')// aqui tendria que traerme como el contenedor que contiene la imagen
    const imagen = document.querySelector(img-poke).setAttribute// aqui tendria que traerme el tag de la imagen y meterle el atributo de src dinamicamente.
}
